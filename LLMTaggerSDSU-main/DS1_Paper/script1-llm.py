...
def get_llm_response(text: str, logger: logging.Logger, model: str) -> Any:
    ...
    prompt = (
        "You are an advanced text-summarize AI. Exclude generic words, extract 10-20 of the most significant keywords and phrases, which can best summarize the main topics and ideas from the following text.\n\n"
        f"{text}\n\n"
