# script2.py Generated labels With LLM
...
def generate_labels_from_extracted_keywords(
    ...
    prompt = f"""
You are an clustering AI that categorizes papers based on extracted tags.  
...
def main():
    ...
    # Inputs/outputs
    INPUT_JSON_PATH = r"DS1_Paper\llm_1_extracted_keywords.json"      
    OUTPUT_JSON_PATH = r"DS1_Paper\llm_2_generated_labels.json"       
    MODEL = "gpt-4o"                                 
